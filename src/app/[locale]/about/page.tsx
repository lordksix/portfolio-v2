...
const AboutPage = () => {
  ...
  return (
    <main className="flex flex-col items-center justify-center w-screen h-screen pt-8 overflow-hidden">
      ...
      <div className="flex flex-col w-8/12 mx-auto my-8 animate-fade-in sm:grid sm:grid-cols-2 sm:gap-x-14">
